...
constraints in an instance of the :class:`neuralmpcx.Nlp` class."""
...
class NlpDebug:
    ...
    of the :class:`neuralmpcx.Nlp` class. In particular, it records information on
    ...
    def register(
        ...
        """
        stack = _dropwhile(
            lambda f: f[0].f_globals["__name__"].startswith("neuralmpcx."), _walk_stack(None)
        )
