...
to :meth:`neuralmpcx.Nlp.solve` or :meth:`neuralmpcx.multistart.MultistartNlp.solve_multi`."""
...
class Solution(_Generic[SymType]):
    ...
    def value(self, x: SymType, eval: bool = True) -> Union[SymType, cs.DM]:
        ...
        eval : bool, optional
            ...
            :meth:`neuralmpcx.solutions.subsevalf` for more details.
