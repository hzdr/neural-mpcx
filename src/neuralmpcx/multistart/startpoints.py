...
class RandomStartPoints:
    ...
    NLP optimization problem (see :class:`neuralmpcx.multistart.MultistartNlp` and its
    subclasses).
...
class StructuredStartPoints:
    ...
    :class:`neuralmpcx.multistart.MultistartNlp` and its subclasses). The points are linearly
